...
} from "./store/userAccountsSlice";
import UserAccountTableHead from "./UserAccountTableHead";
...
function UserAccountTable(props) {
  ...
  function handleClick(item) {
    props.navigate(`/accounts/${item.id}`);
  }
...
export default withRouter(UserAccountTable);
