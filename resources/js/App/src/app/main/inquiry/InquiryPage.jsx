...
function InquiryPage() {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-1 min-w-0">
      <Helmet>
        <title>Inquiry - Find Bookkeeper or Accountant</title>
        <meta name="description" content="Fill out our form and we'll connect you with top freelance bookkeepers and accountants, all for free and with no obligation." />
      </Helmet>
