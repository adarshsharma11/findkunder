...
} from "./store/customerTypesSlice";
import CustomerTypeTableHead from "./CustomerTypeTableHead";
...
function CustomerTypeTable(props) {
  ...
  function handleClick(item) {
    props.navigate(`/customer-types/${item.id}`);
  }
...
export default withRouter(CustomerTypeTable);
